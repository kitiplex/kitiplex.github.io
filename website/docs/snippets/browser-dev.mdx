...
A new browser game developed by Microsoft that is shipped with the Microsoft Edge web browser.
...
<BrowserWindow>
![surf_on_edge](./img/surf_on_edge.png)
</BrowserWindow>